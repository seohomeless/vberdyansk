...
<p style="padding-top: 10px;">Заполните поля - </p>
    ...
    <ul class="kva2">
       ...
       <a href="/hotels/create"> <li class="kva"><img src="/img/f3.png"><br>Добавить отель или гостиницу</li></a>
        <li class="kva active"><img src="/img/f4.png"><br>Добавить частный сектор</li>
    </ul>
    <div>
        <div>
		
		
        <div><h1>Добавить частный сектор</h1><form method="POST" action="{{action('RoomsController@store')}}" enctype="multipart/form-data" />
  {{ csrf_field() }}
